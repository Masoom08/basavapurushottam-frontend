  ...
  return (
    <section className="pt-24 bg-gradient-to-b from-[#b7d2db] to-[#d7a48f]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        {/* CENTERED CARD */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center max-w-7xl mx-auto">

          {/* IMAGE */}
          <div className="flex justify-center">
           
            <img
              src="https://basavapurushottam.com/wp-content/uploads/2025/12/sqq.jpg"
              alt="Mountain"
              className="
                rounded-xl
                shadow-2xl
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex gap-4 mt-5 justify-center md:justify-start">
              <a
                href="https://www.facebook.com/basava.ias"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white shadow-md p-3 rounded-full hover:scale-105 transition-transform"
                aria-label="Facebook"
              >
                <FaFacebookF size={18} />
              </a>
              ...
              <a
                href="https://www.linkedin.com/in/basava-purushottam-b862247?originalSubdomain=in"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white shadow-md p-3 rounded-full hover:scale-105 transition-transform"
                aria-label="LinkedIn"
